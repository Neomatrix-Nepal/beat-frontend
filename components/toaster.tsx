...
{description}            </ToastDescription>
            ...
            <div className="w-full space-y-2">
              ...
              <button className="w-full rounded-md border border-zinc-600 py-2 text-sm text-zinc-300 transition hover:bg-zinc-800">
                Close
              </button>
            </div>
          </div>

          <ToastClose className="absolute right-3 top-3 text-white/50 hover:text-white" />
        </Toast>
      ))}
      <ToastViewport />
    </ToastProvider>
