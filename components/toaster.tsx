...
export function Toaster() {
  ...
  const getIcon = (variant: string | undefined) => {
    switch (variant) {
      case "create": return <CheckCircle className="h-6 w-6 text-white" />;
      case "update": return <Pencil className="h-6 w-6 text-white" />;
      case "delete": return <Trash2 className="h-6 w-6 text-white" />;
      case "info": return <Info className="h-6 w-6 text-white" />;
      default: return null;
    }
  };
