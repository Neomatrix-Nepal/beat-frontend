...
import { BeatsTableProps, DripsTableProps } from "@/src/types";
              ...
              drips?.map((drip, index) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium border ${
                        genreColors[drip.subCategory?.name] ||
                        "bg-gray-500/20 text-gray-400 border-gray-500/30"
                      }`}
                    >
                      {drip?.subCategory?.name || ""}
                    </span>
                  </td>
                  ...
                  <td className="p-4 text-slate-400">
                    {formatDateTime(drip.updated_at)}
                  </td>
                  <td className="p-4">
