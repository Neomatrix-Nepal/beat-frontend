  ...
  return [
    {
      ...
      publicCount: stats?.totalBeatsUploaded?.subCount?.other ?? 0,
      adminCount: stats?.totalBeatsUploaded?.subCount["Raus Ray"] || 0,
      value: stats?.totalBeatsUploaded?.count ?? 0,
      icon: Download,
      iconColor: "bg-[#6c5ce7]",
    ...
    },
    {
      ...
      publicCount: stats?.beatsSoldThisMonth?.subCount?.other ?? 0,
      adminCount: stats?.beatsSoldThisMonth?.subCount["Raus Ray"] || 0,
      value: stats?.beatsSoldThisMonth?.count ?? 0,
      icon: Tag,
      iconColor: "bg-[#fd79a8]",
    ...
    },
    {
      ...
      publicCount: stats?.totalBeatsEarnings?.subCount?.other ?? 0,
      adminCount: stats?.totalBeatsEarnings?.subCount["Raus Ray"] || 0,
      value: stats?.totalBeatsEarnings?.count ?? 0,
      icon: DollarSign,
      iconColor: "bg-[#fdcb6e]",
    ...
    },
    {
      ...
      value: stats?.dripsSoldThisMonth ?? 0,
      icon: Tag,
      iconColor: "bg-[#a29bfe]",
    ...
    },
    {
      ...
      value: stats?.totalDripsEarnings?? 0,
      icon: DollarSign,
      iconColor: "bg-[#00b894]",
